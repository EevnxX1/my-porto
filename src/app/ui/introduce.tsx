...
export default function Introduce() {
    return(
        ...
        <main className="w-[1400px] max-[1540px]:w-[1200px] max-[1300px]:w-[1000px] max-[1060px]:w-[800px] max-[860px]:w-[90%] max-md:w-full m-auto h-[88vh] flex max-[860px]:flex-col justify-between">
            <section className="max-[860px]:absolute max-[860px]:bottom-[50px] max-[630px]:bottom-[120px] max-[500px]:bottom-[90px] max-[860px]:order-2 flex flex-col gap-y-10 max-[1540px]:gap-y-8 max-[1060px]:gap-y-6 max-[860px]:gap-y-7 max-[630px]:gap-y-8 max-[1540px]:mt-20 mt-24 max-[1060px]:mt-24 max-[860px]:w-full">
                <div className="relative h-[220px] max-[1540px]:h-[180px] max-[1300px]:h-[150px] max-[1060px]:h-[120px] max-[860px]:h-[180px] max-[800px]:h-[150px] max-[500px]:h-[100px] max-[450px]:h-[90px]">
                    <div 
                    // data-aos="fade-right" 
                    className={clsx('text-7xl max-[1540px]:text-6xl max-[1300px]:text-5xl max-[1060px]:text-4xl max-[860px]:text-5xl max-[500px]:text-3xl max-[800px]:text-4xl max-[450px]:text-2xl font-semibold absolute max-[1540px]:w-[850px] w-[1000px] max-[630px]:pl-3 z-10', montserrat.className)}>
                ...
                <div data-aos="fade-right" data-aos-delay="400" className="max-[860px]:text-center max-[860px]:self-center w-[500px] max-[500px]:w-[300px] text-lg max-[1060px]:text-sm max-[860px]:text-lg max-[630px]:text-sm">
                ...
                <div data-aos="fade-right" data-aos-delay="600" className="flex gap-x-20 max-[860px]:gap-x-10 max-[630px]:gap-x-6 max-[500px]:gap-x-0 max-[860px]:self-center">
                    <div className="flex flex-col items-center gap-y-1 max-[860px]:gap-y-2 max-[860px]:w-[150px] max-[450px]:w-[120px]">
                        <h1 data-aos="fade-down" data-aos-delay="800" className={clsx('text-5xl max-[1060px]:text-4xl max-[860px]:text-5xl max-[500px]:text-3xl', montserrat.className)}>6</h1>
                        <p className="text-sm max-[860px]:text-xl max-[630px]:text-lg max-[500px]:text-sm">Semester</p>
                    </div>
                    <div className="flex flex-col items-center gap-y-1 max-[860px]:gap-y-2 max-[860px]:w-[150px] max-[450px]:w-[120px]">
                        <h1 data-aos="fade-down" data-aos-delay="1000" className={clsx('text-5xl max-[1060px]:text-4xl max-[860px]:text-5xl max-[500px]:text-3xl', montserrat.className)}>3</h1>
                        <p className="text-sm max-[860px]:text-xl max-[630px]:text-lg max-[500px]:text-sm">Project Website</p>
                    </div>
                    <div className="flex flex-col items-center gap-y-1 max-[860px]:gap-y-2 max-[860px]:w-[150px] max-[450px]:w-[120px]">
                        <h1 data-aos="fade-down" data-aos-delay="1200" className={clsx('text-5xl max-[1060px]:text-4xl max-[860px]:text-5xl max-[500px]:text-3xl', montserrat.className)}>2</h1>
