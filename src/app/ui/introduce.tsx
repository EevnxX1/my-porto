    ...
    return(
        ...
        <main className="w-[1400px] max-[1540px]:w-[1200px] max-[1300px]:w-[1000px] max-[1060px]:w-[800px] max-[860px]:w-[90%] max-md:w-full m-auto h-[88vh] flex max-[860px]:flex-col justify-between">
            <section className="max-[860px]:absolute max-[860px]:bottom-[50px] max-[630px]:bottom-[120px] max-[500px]:bottom-[90px] max-[860px]:order-2 flex flex-col gap-y-10 max-[1540px]:gap-y-8 max-[1060px]:gap-y-6 max-[860px]:gap-y-7 max-[630px]:gap-y-8 max-[1540px]:mt-20 mt-24 max-[1060px]:mt-24 max-[860px]:w-full">
                <div className="relative h-[220px] max-[1540px]:h-[180px] max-[1300px]:h-[150px] max-[1060px]:h-[120px] max-[860px]:h-[180px] max-[800px]:h-[150px] max-[500px]:h-[100px]">
                    <div 
                    // data-aos="fade-right" 
                ...
                <div data-aos="fade-right" data-aos-delay="600" className="flex gap-x-20 max-[860px]:gap-x-10 max-[630px]:gap-x-6 max-[500px]:gap-x-0 max-[860px]:self-center">
                    <div className="flex flex-col items-center gap-y-1 max-[860px]:gap-y-2 max-[860px]:w-[150px]">
