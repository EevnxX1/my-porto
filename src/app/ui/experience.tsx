...
export default function Experience() {
    return(
        <main className="py-20 bg-white text-black">
            <div className="flex flex-col gap-y-20 w-[1400px] max-xl:w-[1000px] max-2xl:w-[1200px] max-lg:w-[800px] m-auto">
